    ...
    namespace templates
    {
        ...
        namespace twtstight
        {
            ...
            HDINLINE std::tuple<
                ...
                float_T,
                float_T>
            TWTSTight<T_Field>::defineBasicHelperVariables() const
            {
            ...
            template<typename T_Field>
            HDINLINE std::tuple<float_T, float_T, float_T, float_T> TWTSTight<T_Field>::defineMinimalCoordinates(
                float3_64 const& pos,
                float_64 const& time) const
            {
                ...
                float_64 const deltaT = wavelength_SI / sim.si.getSpeedOfLight()
                    / (1.0 - beta_0 * math::cos(precisionCast<float_64>(phi)));
            ...
            template<typename T_Field>
            HDINLINE std::tuple<float_T, float_T, float_T, float_T, float_T> TWTSTight<
                T_Field>::defineTrigonometryShortcuts(float_T const& absPhi, float_T const& sinPhi) const
            {
            ...
            HDINLINE std::tuple<
                ...
                alpaka::Complex<float_T>,
                alpaka::Complex<float_T>>
            TWTSTight<T_Field>::defineCommonHelperVariables(
