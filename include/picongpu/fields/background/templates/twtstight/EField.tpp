    ...
    namespace templates
    {
        ...
        namespace twtstight
        {
            ...
            std::tuple<
                ...
                EField::float_T,
                EField::float_T>
            EField::defineBasicHelperVariables() const
            {
            ...
            HDINLINE
            std::tuple<EField::float_T, EField::float_T, EField::float_T, EField::float_T> EField::
            ...
            HDINLINE
            std::tuple<EField::float_T, EField::float_T, EField::float_T, EField::float_T, EField::float_T> EField::
                defineTrigonometryShortcuts(EField::float_T const absPhi, EField::float_T const sinPhi) const
            {
            ...
            std::tuple<
                ...
                alpaka::Complex<EField::float_T>,
                alpaka::Complex<EField::float_T>>
            EField::defineCommonHelperVariables(
                EField::float_T const absPhi,
                EField::float_T const sinPhi,
                EField::float_T const cosPhi,
                EField::float_T const beta0,
                EField::float_T const tanAlpha,
                EField::float_T const cspeed,
                EField::float_T const lambda0,
                EField::float_T const omega0,
                EField::float_T const tauG,
                EField::float_T const w0,
                EField::float_T const k,
                EField::float_T const x,
                EField::float_T const y,
                EField::float_T const z,
                EField::float_T const t,
                EField::float_T const cotPhi,
                EField::float_T const sinPhi_2) const
            {
